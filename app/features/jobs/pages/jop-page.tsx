...
import type { Route } from "./+types/jop-page";
...
export const meta: Route.MetaFunction = ({ params }) => [
  ...
  {
    name: "description",
    content: `View job details for ${params.jobId} on wemake`,
  },
];

export default function JopPage({ params }: Route.ComponentProps) {
  return (
    <div>
      ...
      <div className="grid grid-cols-6 -mt-20 gap-20 items-start">
        <div className="col-span-4 space-y-10">
          <div className="size-40 bg-white rounded-full overflow-hidden left-10 relative">
            <img
